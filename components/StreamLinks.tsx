...
export default function Component(params: any) {
  return (
    <section className="py-12 min-h-full">
      <div className="container mx-auto px-4 md:px-6 grid gap-y-8 grid-cols-2">
      </div>
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-2 items-center gap-8 pt-1">
        <div className="">
          <iframe id={params.discoTrackId}
                  name={params.discoTrackId}
                  allowFullScreen
        ...
        <div className="">
          ...
          <div className="grid gap-4 place-content-stretch">
            ...
            {/* Amazon Music */}  
            {params.amazonMusicLink && (
              <Link
                className="flex items-center gap-4 bg-gray-200 dark:bg-gray-800 p-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
                target="_blank"
                href={params.amazonMusicLink}
              >
    ...
    <svg
      ...
      <defs>
        <linearGradient id="paint0_linear_1070_27987" x1="11" y1="0" x2="11" y2="13.2283" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4200FF"></stop>
          <stop offset="0.5" stopColor="#3A0DBC"></stop>
          <stop offset="1" stopColor="#2C2170"></stop>
        </linearGradient>
      </defs>
    </svg>
  )
