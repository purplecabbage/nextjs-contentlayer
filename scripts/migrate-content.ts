...
// Requires: NEXT_PUBLIC_SUPABASE_SERVICE_ROLE_KEY2_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY2

const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_SERVICE_ROLE_KEY2_SUPABASE_URL!
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY2!

if (!supabaseUrl || !supabaseServiceKey) {
  console.error("Missing NEXT_PUBLIC_SUPABASE_SERVICE_ROLE_KEY2_SUPABASE_URL or SUPABASE_SERVICE_ROLE_KEY2")
  process.exit(1)
}
